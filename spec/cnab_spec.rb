  ...
  describe 'parsed object' do
    ...
    context 'with merged #detalhes' do
      ...
      it 'should respond_to json' do
        # line1 = {"banco"=>"012", "lote"=>"3456", "tipo_registro"=>"7", "num_registro"=>"89012", "segmento"=>"T", "res...\"8901234567", "tarifa"=>"890123456789012", "motivo"=>"3456789012", "res_cnab2"=>"34567890123456789"}
